...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000750u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000774u)
...
#define BS_PHUB_CFGMEM2_VAL ((const uint8 CYFAR *)0x48000788u)

/* PHUB_CFGMEM4 Address: CYREG_PHUB_CFGMEM4_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM4_VAL ((const uint8 CYFAR *)0x4800078Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AMUX, 0x01u);
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP0_MX, 0x01090108u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP2_MX, 0x01060102u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW0, 0x4Cu);
...
uint8 CYXDATA * const CYCODE AMux_2__addrTable[4] = {
	...
	(uint8 CYXDATA *)CYREG_SC3_SW8, (uint8 CYXDATA *)CYREG_SAR1_SW0, 
};
