...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)(0x48000668u + CYAPP_ECC_OFFSET))
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT3_AMUX, 0x6190u);
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP2_MX, 0x01050101u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW0, 0x65u);
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE Amux_Trigger__addrTable[3] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE Amux_Trigger__maskTable[3] = {
	0x80u, 
	0x80u, 
	0x04u, 
};
